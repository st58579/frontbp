...
import {updateUserDetails, uploadUserProfilePicture} from "../api/UserApi";

const UpdateUserDetails = observer(({show, onHide}) => {
    ...
    const onSubmit = () => {
        ...
        reader.onload = () => {
            ...
            updateUserDetails(userStore.id, data).then(onHide).catch(error => {
                console.log('Error while updating user datails');
            });
        };
